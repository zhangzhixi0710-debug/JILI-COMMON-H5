<template>
    <div class="single-images-list">
        ...
        <template v-if="item.PlateSymbolExtend">
            <div class="single-images-contain">
                ...
                <div class="single-images-footer" v-if="item.AwardDataVec?.length">
                    ...
                    >
                        <span>{{ formatNumber(opt.LineNum) }}</span>
                    </div>
                </div>
            </div>
        </template>
        ...
        <div v-if="item.bonusWin" class="single-images-event">
            <span>{{ $t("BonusWin") }}</span>
            <span>{{ formatNumber(item.bonusWin) }}</span>
        </div>

        <div v-if="item.isFrist && item.FreeRemainRound" class="single-images-event">
