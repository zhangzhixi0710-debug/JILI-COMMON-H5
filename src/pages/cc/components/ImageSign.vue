                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                ...
                                v-if="item.RoundMultImages[i][imgIndex]"
                                :class="{
                            ...
                            >
                                <img
                                    v-if="im"
                                    v-for="(im, symbolNumIndex) in item.RoundMultImages[i][
                                        imgIndex
                                    ]"
                                    :key="symbolNumIndex"
                                    :class="{
                                        'single-images-num-single':
                                            item.RoundMultImages[i][imgIndex],
                                    }"
                                    :style="{
                                        'max-width':
                                            (
                                                100 / item.RoundMultImages[i][imgIndex].length
                                            ).toFixed(0) + '%',
                                    }"
                                    :src="im"
                                />
