            ...
            <template v-if="item.PlateSymbolExtend">
                <div class="single-images-contain">
                    ...
                    <div class="single-images-mult">
                        <div v-for="(header, mIndex) in item.HeaderImage" :key="mIndex">
                            <img :src="melt" v-for="(melt, mInd) in header" :key="mInd" />
                        </div>
                    </div>
                    <div
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <img :src="item.PlateSymbolNumImg[i][imgIndex].img" />
                                    ...
                                    <template
                                        v-if="item.PlateSymbolNumImg[i][imgIndex].imgs"
                                    ></template>
                                    <img
                                        v-for="mul in item.PlateSymbolNumImg[i][imgIndex].imgs"
                                        :src="mul"
                                        ...
                                        :style="{
                                            'max-width':
                                                (
                                                    100 /
                                                    (item.PlateSymbolNumImg[i][imgIndex].imgs
                                                        .length +
                                                        1)
                                                ).toFixed(0) + '%',
                                        }"
