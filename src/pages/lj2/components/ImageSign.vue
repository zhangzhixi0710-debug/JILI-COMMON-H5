        ...
        <div v-for="(item, index) in config.plates" :key="index">
            ...
            <template v-if="item.PlateSymbolExtend">
                <div class="single-images-contain">
                    <!-- 中间中奖格子区 -->
                    <div class="single-images-mult" v-if="item.Mult">x&nbsp;{{ item.Mult }}</div>
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    ...
                                    v-if="item.MultImages?.[i]?.[imgIndex]"
                                    :class="{
                                ...
                                >
                                    <img
                                        v-if="mul"
                                        v-for="(mul, mulIndex) in item.MultImages[i][imgIndex]"
                                        :src="mul"
                                        :class="{
                                            'single-images-num-single':
                                                item.MultImages[i][imgIndex][mulIndex],
                                        }"
                                        :style="{
                                            width:
                                                (
                                                    100 /
                                                    (item.MultImages[i][imgIndex].length + 2)
                                                ).toFixed(0) + '%',
                                        }"
                                    />
                                </div>
