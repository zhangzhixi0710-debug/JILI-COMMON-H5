        ...
        <div v-for="(item, index) in config.plates" :key="index">
            ...
            <template v-else>
                <template v-if="config.plates.length - 1 === index">
                    ...
                    <div
                        v-if="config.RoundMult && config.plates.length - 1 === index"
                        class="single-images-event"
                    >
                        <span>{{ $t("i18_Multiplier") }}：</span>
                        <span>{{ config.RoundMult }}</span>
                    </div>
                </template>
            </template>

            <div v-if="keyValue === 0 && isFreeGame" class="single-images-event">
