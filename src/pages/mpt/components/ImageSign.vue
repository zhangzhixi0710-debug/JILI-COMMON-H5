<template>
    <div class="single-images-list">
        ...
        <div class="single-images-footer-tip" v-if="isAwred">
            ...
            <div class="single-images-event" v-if="MiniSoreMoney">
                <span>{{ $t("MiniScore") }}</span>
                <span>{{ formatNumber(MiniSoreMoney) || 0 }}</span>
            </div>
            <div class="single-images-event" v-if="MinorMoney">
                <span>{{ $t("MinorNumber") }}</span>
                <span>{{ formatNumber(MinorMoney) || 0 }}</span>
            </div>
            <div class="single-images-event" v-if="MajorMoney">
                <span>{{ $t("MajorrScore") }}</span>
                <span>{{ formatNumber(MajorMoney) || 0 }}</span>
            </div>
        </div>
    </div>
</template>
